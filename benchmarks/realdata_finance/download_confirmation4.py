#!/usr/bin/env python3
"""Cache the fourth untouched company universe for silence-escape confirmation."""
...
def main() -> None:
    ...
    if args.force or not news_path.exists():
        news = fetch_news(CONFIRMATION4_UNIVERSE)
