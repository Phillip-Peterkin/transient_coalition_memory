#!/usr/bin/env python3
"""Cache the pre-declared untouched ticker universe for confirmation."""
...
def main() -> None:
    ...
    if args.force or not news_path.exists():
        news = fetch_news(CONFIRMATION_UNIVERSE)
