#!/usr/bin/env python3
"""Cache the sixth untouched company universe for diagnostic-contrast v2."""
...
def main() -> None:
    ...
    if args.force or not news_path.exists():
        news = fetch_news(CONFIRMATION6_UNIVERSE)
    ...
    meta = {
        ...
        "declared_symbols": CONFIRMATION6_UNIVERSE,
