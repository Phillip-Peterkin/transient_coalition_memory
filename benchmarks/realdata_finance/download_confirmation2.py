#!/usr/bin/env python3
"""Cache the second untouched company universe for relevance-gate confirmation."""
...
from confirmation2_universe import CONFIRMATION2_UNIVERSE
...
def main() -> None:
    ...
    if args.force or not news_path.exists():
        news = fetch_news(CONFIRMATION2_UNIVERSE)
    ...
    meta = {
        "role": "untouched_relevance_confirmation",
        "news_dataset": NEWS_DATASET,
        "selection": "disjoint fixed universe; selected from raw news-row coverage only",
        "declared_symbols": CONFIRMATION2_UNIVERSE,
